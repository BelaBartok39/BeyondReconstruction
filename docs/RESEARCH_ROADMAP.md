...
**Last Updated:** 2026-01-25 (Reproduction validation added)

## Current State Summary

**Achieved Results:**
- **0.9565 AUROC** with hybrid detection (freq_weight=0.7) - reproduced Jan 2025
...
- **Live HackRF validation: 0.8631 AUROC** on real captured RF signals (V2 model)
- **POWDER DSSS validation: 0.8746 AUROC** on real LTE with spread-spectrum interference (unseen anomaly type)

**Reproducibility Verified (Jan 2026):**
- V1 and V2 models perform within 1-2% of each other
- Optimal freq_weight is 0.6-0.7 (not 0.5)
- Results consistent across synthetic, POWDER, and HackRF datasets
